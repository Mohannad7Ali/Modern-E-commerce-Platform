 ...
 */
router.post('/admin', requireAuth, requireRole('SUPERADMIN'), validateDto(CreateAdminDto), userController.createAdmin);
 ...
 */
router.get('/:id', requireAuth, requireRole('ADMIN', 'SUPERADMIN'), validateDto(UserIdDto), userController.getUserById);
