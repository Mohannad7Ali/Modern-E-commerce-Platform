 ...
 */
router.get('/', requireRole('ADMIN', 'SUPERADMIN'), sectionController.getAllSections);
 ...
 */
router.post('/', upload.array('images', 5), requireRole('ADMIN', 'SUPERADMIN'), sectionController.createSection);
 ...
 *         description: Invalid input data.
 */
router.put('/:type', requireRole('ADMIN', 'SUPERADMIN'), sectionController.updateSection);
 ...
 */
router.delete('/:type', requireRole('ADMIN', 'SUPERADMIN'), sectionController.deleteSection);
