...
router.post('/', upload_middleware_1.upload.array('images', 5), controller.createVariant);
/**
 * @swagger
 * /variants/{id}:
 *   patch:
 ...
 *         description: Variant not found
 */
router.patch('/:id', upload_middleware_1.upload.array('images', 5), controller.updateVariant);
