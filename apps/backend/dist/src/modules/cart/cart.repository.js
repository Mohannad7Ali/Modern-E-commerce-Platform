...
class CartRepository {
    ...
    async addItemToCart(data) {
        ...
        try {
            ...
            const item = await prisma_1.prisma.cartItem.create({ data });
    ...
    async removeCartItem(itemId) {
        ...
        console.log('🔍 [CART REPOSITORY] itemId:', itemId);
        const result = await prisma_1.prisma.cartItem.delete({ where: { id: itemId } });
    ...
    async mergeCarts(sessionCartId, userCartId) {
        ...
        const sessionItems = await prisma_1.prisma.cartItem.findMany({
        ...
        await prisma_1.prisma.cart.delete({ where: { id: sessionCartId } });
    ...
    async deleteCart(id) {
        ...
        const result = await prisma_1.prisma.cart.delete({ where: { id } });
