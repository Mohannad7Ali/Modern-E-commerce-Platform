 ...
 */
router.post('/interactions', protect_middleware_1.requireAuth, controller.createInteraction);
/**
 * @swagger
 ...
 *         description: Unauthorized. Token is invalid or missing.
 */
router.get('/year-range', protect_middleware_1.requireAuth, controller.getYearRange);
/**
 * @swagger
 * /analytics/export:
 *   get:
 ...
 *         description: Unauthorized. Token is invalid or missing.
 */
router.get('/export', protect_middleware_1.requireAuth, controller.exportAnalytics);
