...
class ProductController {
    constructor(productService) {
        ...
        this.getAllProducts = (0, asyncHandler_1.default)(async (req, res) => {
            const { products, totalResults, totalPages, currentPage, resultsPerPage } = await this.productService.getAllProducts(req.query);
        ...
        this.getProductById = (0, asyncHandler_1.default)(async (req, res) => {
            const productId = (0, checkType_1.CheckParamsType)(req.params.id);
        ...
        this.getProductBySlug = (0, asyncHandler_1.default)(async (req, res) => {
            const productSlug = (0, checkType_1.CheckParamsType)(req.params.id);
        ...
        this.createProduct = (0, asyncHandler_1.default)(async (req, res) => {
            ...
            if (typeof variants === 'string') {
                try {
                    ...
                    throw new AppError_1.default(400, 'Invalid variants format');
                }
            }
            // Validate variants
        ...
        this.updateProduct = (0, asyncHandler_1.default)(async (req, res) => {
            ...
            const processedVariants = parsedVariants.length
                ? await Promise.all(parsedVariants.map(async (variant, index) => {
                    ...
                    if (!Array.isArray(bodyImages) || bodyImages.some((img) => img && typeof img !== 'string')) {
                    ...
                    imageUrls = [...imageUrls, ...bodyImages.filter((img) => img)];
